const WELCOME_PROJECTS = [
    ...
    { name: "Weather Worsener", icon: "🌧️", url: "https://nerktendo.com/weather-worsener", type: "Game", learning: "Climate awareness game where you control disasters and try to eradicate humanity" },
...
const WORKSHOP_PROJECTS = [
    ...
    { name: "Dune: Imperium Strategy Guide", author: "Ben Von Wong", url: "https://dune-strategy-guide.web.app/", type: "Board Games", desc: "Strategy companion for the board game — select your player count, pick a leader, get recommendations" },
